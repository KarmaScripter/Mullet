...
namespace BudgetExecution
{
    ...
    static internal class NativeMethods
    {
        ...
        [ DllImport( "user32" ) ]
        static internal extern bool AnimateWindow( IntPtr hWnd, int dwTime, int dwFlags );

        [ DllImport( "Gdi32.dll", EntryPoint = "CreateRoundRectRgn" ) ]
        static internal extern IntPtr CreateRoundRectRgn( int nLeftRect, int nTopRect, int nRightRect, int nBottomRect,
